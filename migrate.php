...
$migrations = [
    ...
    ["ALTER TABLE system_accounts ADD COLUMN auto_hide_phone_enabled TINYINT DEFAULT 0", "system_accounts.auto_hide_phone_enabled"],
    ["ALTER TABLE system_accounts ADD COLUMN auto_hide_keywords_enabled TINYINT DEFAULT 0", "system_accounts.auto_hide_keywords_enabled"],
    ["ALTER TABLE system_accounts ADD COLUMN auto_hide_keywords_text TEXT DEFAULT NULL", "system_accounts.auto_hide_keywords_text"],
    ...
    // Website Chat Widget & AI Bot Tables
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", "web_chat_configs table"],
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", "web_visitors table"],

    ["ALTER TABLE web_visitors ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP", "web_visitors.created_at"],
    ...
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", "web_messages table"],
    ["ALTER TABLE web_chat_configs ADD COLUMN widget_position VARCHAR(20) DEFAULT 'right'", "web_chat_configs.widget_position"],
