...
// Consume flash messages BEFORE closing session writing
$global_flash_msg = '';
$global_flash_error = '';
$global_flash_type = 'success';

if (!empty($_SESSION['flash_msg'])) {
    $global_flash_msg = $_SESSION['flash_msg'];
    unset($_SESSION['flash_msg']);
}
if (!empty($_SESSION['flash_error'])) {
    $global_flash_error = $_SESSION['flash_error'];
    unset($_SESSION['flash_error']);
}
if (!empty($_SESSION['flash_type'])) {
    $global_flash_type = $_SESSION['flash_type'];
...
<head>
    ...
    <title>HONGDOLABS - Hệ thống Quản lý đa nền tảng</title>
