...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="<?php echo ($current_page == 'facebook_scraper') ? 'active' : ''; ?>">
            <a href="facebook_scraper.php" data-tooltip="Content Studio"><span class="icon">🕸️</span><span class="menu-label"> Content Studio</span></a>
        </li>
        ...
        <li class="<?php echo ($current_page == 'live_chat' || $current_page == 'live_chat_zalo') ? 'active' : ''; ?>">
