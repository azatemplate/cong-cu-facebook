...
<head>
    ...
    <title>Đăng nhập - HONGDOLABS</title>
    ...
    <div class="left-panel">
        <div class="left-content">
            <div class="brand-header">
                <img src="logo.png" alt="HONGDOLABS Logo" style="width: 44px; height: 44px; border-radius: 10px; object-fit: contain; flex-shrink: 0;">
