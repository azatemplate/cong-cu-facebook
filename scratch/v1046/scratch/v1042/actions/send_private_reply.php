...
// 2. Send via Send API (/{page_id}/messages) with recipient.comment_id
$endpoint = "{$page_id}/messages";
$params_priv = ['access_token' => $token];
$payload_priv = json_encode([
    'recipient' => ['comment_id' => $target_id],
    'message'   => ['text' => $message]
], JSON_UNESCAPED_UNICODE);

$response = fb_api_request($endpoint, $params_priv, 'POST', $payload_priv);
