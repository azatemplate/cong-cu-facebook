...
try {
    ...
    // Tự động đẩy API nếu đủ điều kiện
    try {
    ...
    // --- Bắt đầu chạy các tác vụ nền ---
    
    // 1. Đồng bộ nhãn lên Facebook nếu cần
    if ($need_fb_sync) {
        // Insert local label
    ...
    // CAPI không được gửi từ đây. Chỉ gửi khi:
    // 1. Bấm nút "Đẩy lên Facebook CAPI" (thủ công) → push_to_capi.php
    // 2. Auto CAPI bật + webhook phát hiện SĐT mới → webhook.php
