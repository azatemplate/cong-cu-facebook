...
if (!$enable_live_chat_tiktok) {
    ...
    echo '  <p style="color:#4b5563; font-size:14px; margin-bottom:0;">Tính năng Live Chat TikTok đã bị tắt cho tài khoản của bạn. Vui lòng liên hệ Admin để kích hoạt lại.</p>';
    echo '</div>';
