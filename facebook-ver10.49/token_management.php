                        ...
                        <?php if ($is_admin || $drive_multi_api): ?>
                            <td>
                                <?php if (!empty($u['gg_client_id'])): ?>
                                    <span class="status-tag" style="background: #e0f2fe; color: #0369a1; font-size: 11px; padding: 2px 6px; border-radius: 4px; font-weight: 600;">API Riêng</span><br>
                                ...
                                <?php else: ?>
                                    <span class="status-tag" style="background: #f1f5f9; color: #475569; font-size: 11px; padding: 2px 6px; border-radius: 4px; font-weight: 500;">API Mặc định (Settings)</span><br>
                                <?php endif; ?>
                                
                                <?php if (!empty($u['gg_refresh_token'])): ?>
                                    <span class="status-tag" style="background: #ecfdf5; color: #047857; font-size: 11px; padding: 2px 6px; border-radius: 4px; font-weight: 600; margin-top: 3px; display: inline-block;">Drive Riêng: Đã liên kết</span>
                                <?php else: ?>
                                    <span class="status-tag" style="background: #f1f5f9; color: #64748b; font-size: 11px; padding: 2px 6px; border-radius: 4px; font-weight: 500; margin-top: 3px; display: inline-block;">Drive: Mặc định (Settings)</span>
                                <?php endif; ?>
                            </td>
                        <?php endif; ?>
