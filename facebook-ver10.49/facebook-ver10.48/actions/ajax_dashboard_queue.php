...
try {
    ...
    $stmt_recent = $pdo->prepare("
        ...
        LEFT JOIN youtube_channels yt ON (CAST(sp.page_id AS BINARY) = CAST(yt.id AS BINARY) OR CAST(sp.page_id AS BINARY) = CAST(yt.channel_id AS BINARY)) AND sp.post_type = 'YouTube'
