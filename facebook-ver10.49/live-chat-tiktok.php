...
// 2. Fetch system account settings & feature flags
...
if (!$enable_live_chat_tiktok) {
    echo '<div style="padding: 30px; text-align: center; color: #ef4444; font-weight: bold; font-size: 18px;">⚠️ Tính năng Live Chat TikTok đã bị tắt cho tài khoản của bạn. Vui lòng liên hệ Admin.</div>';
