...
// Giải phóng session lock sớm — cho phép các request khác chạy song song
session_write_close();

header('Content-Type: application/json');

$cache_key = "dashboard:metrics:" . ($is_admin ? "admin" : $account_id);
