...
$rq_scraper = RedisQueue::getInstance();
if (!$rq_scraper->acquireLock('lock:cron:start_scraper', 900)) {
    echo "Tiến trình start_scraper.php đang chạy (Redis Lock). Bỏ qua.\n";
    return;
}
...
$rq_scraper->releaseLock('lock:cron:start_scraper');